        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  "${LocaleKeys.shop_by_category_screen_browsByCategoryTitle.tr()}",
                  style: TextStyle(
                    fontSize: 16
                  ),
                ),
                ...
                SingleChildScrollView( 
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 5),
                      FutureBuilder<List>( 
                        future: fetchSubCategories(categoryId: widget.category.id),
                                ...
                                GestureDetector(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        "${context.locale}" == 'ar' ?  widget.category.name 
